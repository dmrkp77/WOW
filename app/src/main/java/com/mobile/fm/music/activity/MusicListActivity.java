package com.mobile.fm.music.activity;
...
import com.mobile.fm.music.adapter.CustomAdapterForBarMusic;
...
public class MusicListActivity extends AppCompatActivity {
    ...
    private void init_recyclerView(String name){
        ...
        databaseReference = database.getReference(name); //데이터 베이스 생성 필요
